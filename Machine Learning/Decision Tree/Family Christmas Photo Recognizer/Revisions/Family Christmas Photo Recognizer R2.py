...
def calcGain(yent, feature, m):
    return yent - (np.sum(prop[gain][0])/m) * entropy(prop[gain][0][0]/np.sum(prop[gain][0]), prop[gain][0][1]/np.sum(prop[gain][0]))

x1ent = (np.sum(prop[0][0])/m) * entropy(prop[0][0][0]/np.sum(prop[0][0]), prop[0][0][1]/np.sum(prop[0][0])) + (np.sum(prop[0][1])/m) * entropy(prop[0][1][0]/np.sum(prop[0][1]), prop[0][1][1]/np.sum(prop[0][1]))
x2ent = (np.sum(prop[1][0])/m) * entropy(prop[1][0][0]/np.sum(prop[1][0]), prop[1][0][1]/np.sum(prop[1][0])) + (np.sum(prop[1][1])/m) * entropy(prop[1][1][0]/np.sum(prop[1][1]), prop[1][1][1]/np.sum(prop[1][1]))
x3ent = (np.sum(prop[2][0])/m) * entropy(prop[2][0][0]/np.sum(prop[2][0]), prop[2][0][1]/np.sum(prop[2][0])) + (np.sum(prop[2][1])/m) * entropy(prop[2][1][0]/np.sum(prop[2][1]), prop[2][1][1]/np.sum(prop[2][1]))
